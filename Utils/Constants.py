...
ATTRIBUTE_AUTOSIZE_TEXT_TYPE= 'app:autoSizeTextType'
...
DEFAULT_DRAWABLE_PATH = '/res/drawable-xhdpi'
DEFAULT_LAYOUT_PATH = '/res/layout/'
...
ELEMENT_STRING_ARRAY= 'string-array'
ELEMENT_STYPE = 'style'
ELEMENT_COLOR = 'color'
ELEMENT_ITEM = 'item'
ELEMENT_IMAGE_VIEW = 'ImageView'
ELEMENT_IMAGE_BUTTON = "ImageButton"
ELEMENT_BUTTON = "Button"
ELEMENT_CHECK_BOX = "CheckBox"
ELEMENT_RADIO_BUTTON = "RadioButton"
ELEMENT_SWITCH = "Switch"
ELEMENT_SEEK_BAR = "SeekBar"
ELEMENT_RATING_BAR = "RatingBar"
ELEMENT_SEARCH_BAR = "SearchView"
ELEMENT_SPINNER= "Spinner"
ATTRIBUTE_NAME = 'name'
ATTRIBUTE_DROPDOWN_ENTRIES = "android:entries"
VALUE_STRING_FILE_NAME = 'string'
VALUE_ARRAY_FILE_NAME = 'array'
