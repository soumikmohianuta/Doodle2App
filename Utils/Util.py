...
def getAndroidProjectCreatePath():
    return r"/home/ubuntu/screenshotProcessor/android-sdk/tools/android"
...
def createValidAndroidProjectName(mFileName):
    ...
    if m == None:
        valideName = "project_" + valideName
    else:    
...
#	public static File[] getSubfolder(String imageFolder) {
#		return new File(imageFolder).listFiles(new FileFilter() {
#
#			@Override
